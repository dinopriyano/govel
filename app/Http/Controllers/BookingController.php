...
class BookingController extends Controller
{
    ...
    public function checkout(Request $request)
    {
        ...
        $contact = 'https://api.whatsapp.com/send?phone=6289661011050&text=Halo,%20Saya%20' . $datas->name . '%20sudah%20melakukan%20pembayaran%20untuk%20' . $data->type . '%20yaitu%20' . $data->title . '.%20Berikut%20saya%20lampirkan%20bukti%20pembayaran%20:';
    ...
    public function checkout_transportation(Request $request)
    {
        ...
        $contact = 'https://api.whatsapp.com/send?phone=6289661011050&text=Halo,%20Saya%20' . $datas->name . '%20sudah%20melakukan%20pembayaran%20untuk%20' . $data->type . '%20yaitu%20' . $data->company_name . '.%20Berikut%20saya%20lampirkan%20bukti%20pembayaran%20:';
