                    ...
                    <div class="p-4 rounded-12 bg-white">
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                                ...
                                <form action="{{ route('payment-process', $destination->slug) }}" method="post">
                                @csrf
                                    <div
                                    ...
                                    <div class="bg-color-light px-3 py-4 rounded-12 my-4">
                                        ...
                                        @for($i = 0; $i < $data->rooms; $i++)
                                            <div class="row m-0 my-3 justify-content-between">
                                                <div class="col-8 p-0">
                                                    <p class="fw-bold">{{ $destination->title }} Room (1x)</p>
                                                </div>
                                                <div class="col-4 p-0">
                                                    <p class="fw-bold float-end">$ {{ $destination->price }}</p>
                                                </div>
                                            </div>
                                            @endfor
                                            <div class="row m-0 my-3 justify-content-between">
                                                <div class="col-8 p-0">
                                                    <p class="fw-bold">Other Fees</p>
                                                </div>
                                                <div class="col-4 p-0">
                                                    <p class="fw-bold float-end">$ {{ $other_fees }}</p>
                                                </div>
                                            </div>
                                ...
                                <p class="fw-bold mt-4 text-center text-sm">By clicking this button, you acknowledge
                                    ...
                                    the <a href="#" class="text-decoration-none baseColor">Terms & Conditions</a> and <a
                                        href="#" class="text-decoration-none baseColor">Privacy Policy</a> of Govel</p>
                            </div>
            ...
            <div class="col-lg-5 p-0 ps-lg-5">
                <div class="notice mb-5 p-0">
                    <div class="p-4 rounded-12 bg-white">
                        ...
                        <p class="fw-bold my-1">{{ date('l, F j, Y', strtotime($data->check_in)) }}</p>
                        <p class="fw-bold my-1">{{ $data->duration == 1 ? ' Night' : $data->duration.' Nights' }}</p>
                        <p class="fw-bold my-1">{{ $data->rooms == 1 ? 'Single Room' : $data->rooms.' Rooms' }}</p>
