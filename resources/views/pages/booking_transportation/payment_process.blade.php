                    ...
                    <div class="rounded-12 bg-white overflow-hidden">
                        ...
                        <div class="p-4">
                            ...
                            <div class="row m-0 mt-3">
                                ...
                                <div class="col-lg-6 p-0 mt-lg-0 mt-2">
                                    <p class="fw-bold">PT. Govel Digital Niaga</p>
                                    <p class="fw-bold text-secondary">Govel Digital Niaga</p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="completed alert fade show mb-5 p-0">
                    ...
                    <div class="p-4 rounded-12 bg-white">
                        <p class="fw-bold text-secondary mb-3">Once your payment is completed, we will send your
                            {{ $transportation->type }} voucher to your email address and your phone number</p>
                        <form action="{{ route('checkout-transportation') }}" method="post" enctype="multipart/form-data">
                            @csrf

                            <input type="hidden" name="users_id" id="users_id"
                                value="{{ Auth::user()->id }}">
                            <input type="hidden" name="transaction_transportations_id" id="transaction_transportations_id"
                                value="{{ $datas->id }}">
            ...
            <div class="col-lg-5 p-0 ps-lg-5">
                <div class="notice mb-5 p-0">
                    <div class="p-4 rounded-12 bg-white">
                        ...
                        <p class="fw-bold my-1">Departure Date : {{ date('l, F j, Y', strtotime($datas->departure_date)) }}</p>
                        <p class="fw-bold my-1">Departure Time : {{ date('H:i:s', strtotime($datas->departure_time)) }}</p>
                        <p class="fw-bold my-1">{{ $datas->guests == 1 ? 'Single Seat' : $datas->guests.' Seats' }}</p>
